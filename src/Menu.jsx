...
export function Home() {
 ...
 const handleSubmit3=()=>{
    ...
    return (
        ...
        <button onClick={()=>setqty6(qty6-1)} className='buttons'>-</button><button onClick={()=>setqty6(qty6+1)} className='buttons'>+</button>
          ...
          <h2 style={{textDecoration:"underline"}} className='name'>Tandoori Delights</h2>
 ...
 const handleSubmit3=()=>{
    ...
    return (
        ...
        <h4>3.Watermelon Basil Fizz : {qty3}</h4>
        <p>(200/-)</p>
        <button onClick={()=>setqty3(qty3-1)} className='buttons'>-</button><button onClick={()=>setqty3(qty3+1)} className='buttons'>+</button>
      ...
      <h2 style={{textDecoration:"underline"}} className='name'>Dessert </h2>
      ...
      <h4>Starters + Main :{strtMainTotal}</h4>
       ...
       <button onClick={handleSubmit2}>Order</button>
   </div>
    )
  }
